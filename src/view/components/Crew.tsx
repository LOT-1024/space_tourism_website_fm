...
const Crew: React.FC = () => {
  ...
  const selected = datas.find((element) => element.name === currentDestination);
    ...
    <div className="m-auto flex w-[327px] flex-col items-center text-white md:mt-[40px] md:w-[691px] xl:mt-[62px] xl:w-[1138px] xl:flex-row">
      <div className="flex w-full flex-col xl:self-start">
        ...
        <h2 className="text-center tracking-[2.7px] md:text-left md:text-[20px] md:tracking-[3.38px] xl:text-[28px] xl:tracking-[4.72pxpx]">
          <span className="mr-[18px] text-white/30">02</span>MEET YOUR CREW
        </h2>
        {/* Image in mobile */}
          ...
          {datas.map((data, i) => (
            <button
              ...
              className={`h-[10px] w-[10px] rounded-full ${
                selected === data ? "bg-white" : "bg-white/40 hover:bg-white/60"
              }`}
        ...
        {/* Name, Role, and Bio */}
        <div className="mb-[104px] w-full text-center md:m-auto md:mb-0 md:mt-[60px] md:w-[458px] xl:m-0 xl:mt-[154px] xl:w-[614px] xl:text-left">
